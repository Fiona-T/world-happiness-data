...
### Manual Testing
Manual testing, aside from the [User Stories](#test-cases---user-stories) and [Features Testing](#features-testing) was completed to ensure the application works as intended:
